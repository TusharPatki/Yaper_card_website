...
// import { Linkedin, Instagram } from 'lucide-react'; // Example icons
    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="text-xl font-bold mb-4">Yaper</h4>
            <p className="text-gray-400">Empowering your financial journey with innovative credit card solutions.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">contact@yaper.com</li>
        ...
        <div className="border-t border-gray-800 pt-6">
          <p className="text-center text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Yaper Financial Services. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
